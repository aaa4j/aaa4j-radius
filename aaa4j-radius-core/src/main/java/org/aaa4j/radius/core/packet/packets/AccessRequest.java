 ...
 */
public final class AccessRequest extends Packet {
     ...
     * Packet name.
     */
    public static final String NAME = "Access-Request";

    /**
     * Constructs Access-Request packets.
     */
     ...
     */
    public AccessRequest(List<Attribute<?>> attributes) {
        super(CODE, attributes);
    }

    /**
     * Constructs incoming Access-Request packets.
     *
     * @param attributes the attributes to include in the packet
     * @param receivedFields the received fields from the incoming packet
     */
    public AccessRequest(List<Attribute<?>> attributes, ReceivedFields receivedFields) {
