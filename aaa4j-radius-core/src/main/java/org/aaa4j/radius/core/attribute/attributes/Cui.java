 ...
 * CUI (89) attribute.
 */
public final class Cui extends StandardAttribute<StringData> {

    public static final AttributeType TYPE = new AttributeType(89);

    public static final String NAME = "CUI";

    public Cui(StringData data) {
