...
/**
 * Accounting-Response (5) packet.
 */
public final class AccountingResponse extends Packet {
    ...
    /**
     * Constructs Accounting-Response packets.
     */
     ...
     */
    public AccountingResponse(List<Attribute<?>> attributes) {
        super(CODE, attributes);
    }

    /**
     * Constructs incoming Accounting-Response packets.
     *
     * @param attributes the attributes to include in the packet
     * @param receivedFields the received fields from the incoming packet
     */
    public AccountingResponse(List<Attribute<?>> attributes, ReceivedFields receivedFields) {
